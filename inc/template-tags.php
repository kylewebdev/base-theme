...
if (! function_exists('_base_posted_on')) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function _base_posted_on()
	{
...
if (! function_exists('_base_posted_by')) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function _base_posted_by()
	{
		$byline = sprintf(
...
if (! function_exists('_base_entry_footer')) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function _base_entry_footer()
	{
...
if (! function_exists('_base_post_thumbnail')) :
	/**
